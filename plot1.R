...
png("plot1.png", width=480, height=480) #set image size to 480x480
hist(ddat$Global_active_power, col="red", xlab="Global Active Power (Kilowatts)", main="Global Active Power")
dev.off() 
##################  End Plot 1 Charts ######################################
